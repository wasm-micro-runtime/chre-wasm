...
#ifndef CHRE_PLATFORM_SHARED_NANOAPP_SUPPORT_WASM_H_
#define CHRE_PLATFORM_SHARED_NANOAPP_SUPPORT_WASM_H_
...
#endif  // CHRE_PLATFORM_SHARED_NANOAPP_SUPPORT_WASM_H_
